...
# { \
#   # cargo test --release binary_r1cs -- --skip test_completeness --nocapture && \
#   # cargo test --release test::test_soundness -- --skip r1cs --nocapture && \
#   # cargo test test::test_completeness -- --skip r1cs --nocapture; \
# } |& tee all_tests.log
...
#   nsys profile --stats=true --force-overwrite true -o soundness_profile cargo test --release test::test_soundness -- --skip r1cs --nocapture && \
  nsys profile --stats=true --force-overwrite true -o completeness_profile cargo test test::test_completeness -- --skip r1cs --nocapture; \
} |& tee all_tests_nvtx.log
